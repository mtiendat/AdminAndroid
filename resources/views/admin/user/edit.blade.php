                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="txthoten" class="form-control" value="{{$user->hoten}}">
                                    </div>
                                </div>
                                <div class="col-md-5 pr-1">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">ĐỊA CHỈ</label>
                                        <input type="text" name="txtdiachi" class="form-control" value="{{$user->diachi}}">
                                    </div>
                                </div>
                                <div class="col-md-5 pr-1">
                                    <div class="form-group">
                                ...
                                <div class="col-md-5 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="txtsdt" class="form-control" value="{{$user->sdt}}">
                                    </div>
                                </div>
                                <div class="col-md-5 pr-1">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">LOẠI</label>
                                        <input type="text" name="txtloai" class="form-control" value="{{$user->loai}}">
                                    </div>
                                </div>
                                <div class="col-md-5 pr-1">
                                    <div class="form-group">
